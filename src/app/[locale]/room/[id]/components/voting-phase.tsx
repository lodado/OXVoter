  ...
  return (
    <Card className="bg-slate-800/80 text-white shadow-xl backdrop-blur">
      <Card.Header>
        ...
        {timeLimit && <ProgressBar value={(timeLeft / timeLimit) * 100} className="h-1 bg-slate-700" />}
      </Card.Header>
      <Card.Content>
        {localHasVoted ? (
      ...
      <Card.Footer className="flex justify-center gap-2">
        ...
        {isHost && (
          <Button variant="errorSolid" className="flex flex-row max-w-[150px] w-[30%] h-10 gap-2" onClick={onForceEnd}>
